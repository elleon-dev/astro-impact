    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <main className="flex-1">
        ...
        {currentPhase === "results" && (
          <div className="min-h-screen bg-gradient-to-b from-black via-secondary/20 to-black pt-20 sm:pt-24 px-3 sm:px-8 pb-4">
            <div className="container mx-auto">
              <h2 className="text-2xl sm:text-3xl font-bold text-white mb-6 sm:mb-8 text-center">Visualizaciones del Impacto</h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 max-w-5xl mx-auto mb-8 sm:mb-12">
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Modelo 3D Interactivo</h3>
                ...
                >
                  ...
                  <div className="relative z-10">
                    ...
                    <h3 className="text-lg sm:text-xl font-bold text-white mb-2">Simulación de Impacto</h3>
                    <p className="text-white/60 text-sm">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 sm:gap-6">
            ...
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
                <div className="p-3 sm:p-5 bg-gradient-to-br from-black/50 to-transparent backdrop-blur-sm rounded-xl">
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-white/60">Energía Liberada</p>
                      <p className="text-lg sm:text-2xl font-bold text-primary truncate">{impactData.energyMegatons} MT</p>
                      <p className="text-xs text-white/50 mt-1">
                        Equiv. {(parseFloat(impactData.energyMegatons) / 15).toFixed(1)} bombas Hiroshima
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="p-3 sm:p-5 bg-gradient-to-br from-black/50 to-transparent backdrop-blur-sm rounded-xl">
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-white/60">Diámetro del Cráter</p>
                      <p className="text-lg sm:text-2xl font-bold text-white truncate">{impactData.craterDiameter} m</p>
                      <p className="text-xs text-white/50 mt-1">
                ...
                <div className="p-3 sm:p-5 bg-gradient-to-br from-black/50 to-transparent backdrop-blur-sm rounded-xl">
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-white/60">Víctimas Estimadas</p>
                      <p className="text-sm sm:text-xl font-bold text-destructive">{impactData.estimatedCasualties}</p>
                      <p className="text-xs text-white/50 mt-1">
                ...
                <div className="p-3 sm:p-5 bg-gradient-to-br from-black/50 to-transparent backdrop-blur-sm rounded-xl">
                  <div className="flex items-start gap-2 sm:gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-xs sm:text-sm text-white/60">Destrucción Infraestructura</p>
              ...
              <div className="mt-4 sm:mt-6 p-3 sm:p-5 bg-gradient-to-br from-black/40 to-transparent rounded-xl backdrop-blur-sm">
                <h4 className="font-semibold mb-2 sm:mb-3 text-white text-sm sm:text-base">Parámetros del Asteroide</h4>
            ...
            <div className="space-y-3 sm:space-y-4">
              <div className="p-3 sm:p-5 bg-gradient-to-br from-black/50 to-transparent backdrop-blur-sm rounded-xl">
                <h3 className="text-base sm:text-lg font-bold mb-3 sm:mb-4 text-white">Compartir Resultados</h3>
                
                {/* User Name */}
                <div className="space-y-2 mb-3 sm:mb-4">
                  <Label htmlFor="userName" className="text-xs sm:text-sm text-white/80">Tu Nombre</Label>
                  <Input
                    id="userName"
                ...
                {/* Result URL */}
                <div className="space-y-2 mb-3 sm:mb-4">
                  <Label className="text-xs sm:text-sm text-white/80">Link del Resultado</Label>
                  <div className="flex gap-2">
                    <Input value={resultUrl} readOnly className="flex-1 bg-black/30 border-white/10 text-white text-xs sm:text-sm" />
                    <Button variant="outline" size="icon" onClick={copyLink} className="border-white/10 hover:bg-white/10 h-8 w-8 sm:h-10 sm:w-10">
                ...
                <div className="space-y-2">
                  <Label className="text-xs sm:text-sm text-white/80">Compartir en Redes</Label>
